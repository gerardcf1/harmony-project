...
- If Prisma reports `P1012` about missing opposite relation fields for `Response.question` / `Response.answerOption`, ensure you pulled the latest schema where `Question.responses` and `AnswerOption.responses` are defined.
